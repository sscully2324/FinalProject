...
def print_current_table(data):
    ...
    #!!!!!!!!!need to change format of date somehow !!!!!!!!
...
def main():
    stocks = "AAPL"
    current = get_current_stock_data(stocks, "1min", "25", "f3cdc7c31b684fdf9de786f2f913fa51")
    ...
    fig = px.line(tbl, x=xAxis, y="Average Value", color= "Average Value", title="Average " + current['meta']['symbol'] + " Stock Value per Current Minute")

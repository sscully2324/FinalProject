...
def eod_viz(cur,conn):
    ...
    plt.title("Sentiment Scores for Apple for Past Month")
    plt.xticks(rotation = 45)
    plt.tight_layout()
    plt.xlim(0, 30)
...
def main():
    ...
    #data = get_stock_data_polygon(stocks, "1", "day", "2022-01-11", "2022-30-11", "asc", "25", "SdPhD9OzWCb83KCc6jLIvqDAAARb7Gpd")
